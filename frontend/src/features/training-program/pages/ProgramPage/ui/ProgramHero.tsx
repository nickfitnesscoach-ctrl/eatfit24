...
export function ProgramHero({ client }: ProgramHeroProps) {
    return (
            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm md:text-base">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-foreground">{client.goal}</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="text-muted-foreground">Формат</span>
                        <span className="font-semibold text-foreground">{client.format}</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="text-muted-foreground">Частота</span>
                        <span className="font-semibold text-foreground">{client.trainingsPerWeek}</span>
                    </div>
                    <div className="flex items-center gap-2">
